"""
Scrub — local metadata hygiene and watermark-robustness toolkit (Tk UI).
...
class App(ctk.CTk):
    ...
    def _build(self):
        ...
        self.run_btn = ctk.CTkButton(
            action,
            text="▶  Start — process files locally",
            command=self._run,
    ...
    def _build_settings_card(self, parent) -> ctk.CTkScrollableFrame:
        ...
        row += 1
        ctk.CTkRadioButton(
            card, text="Metadata + signal disruption (recommended)",
        ...
        self.auto_switch = ctk.CTkSwitch(
            card,
            text="Auto — pick a sensible setting for each file",
        ...
        ctk.CTkLabel(
            card,
            text=("Near-lossless by default; bumps to Medium when file "
                  "metadata suggests a known generative origin."),
            font=ctk.CTkFont(size=11), text_color=MUTED,
        ...
        self.spectral_chk = ctk.CTkCheckBox(
            card,
            text="Spectral / frequency-domain disruption",
        ...
        ctk.CTkLabel(
            card,
            text="FFT carrier disruption for images + short videos (≤90s).",
            font=ctk.CTkFont(size=11), text_color=MUTED,
        ...
        self.visible_chk = ctk.CTkCheckBox(
            card,
            text="Inpaint small corner AI-style badges (heuristic)",
