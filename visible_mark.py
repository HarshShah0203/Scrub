"""
Visible corner-badge inpaint (small AI-style UI marks).

Some generative UIs place a compact high-contrast mark near a corner.
This module uses a conservative heuristic (no ML model):

  * Scan the four corners for a compact high-contrast blob on a relatively
    flat local background (typical ~48×48 / 96×96 marks).
  ...
  * If nothing looks like a badge, the image is unchanged.

Large artistic overlays and stock-photo watermarks are out of scope.
"""
