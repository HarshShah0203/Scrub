"""
Before/after provenance audit for Scrub runs.

Writes a small JSON sidecar summarizing removable provenance *signals* on
the input vs output so you can confirm tags you care about are gone
(offline, no network). Best-effort bookkeeping — not a legal certificate.
"""
